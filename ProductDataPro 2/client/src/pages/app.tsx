        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="ml-4 sm:ml-6">
              <button 
                onClick={() => setLocation("/marketmind")}
                className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg px-4 py-2 text-sm font-medium shadow-sm hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 flex items-center space-x-2"
              >
                <span>✨ Try MarketMind AI</span>
              </button>
            </div>
