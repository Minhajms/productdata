          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <div ref={ctaButtonRef.ref} className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4 fade-up delay-300">
                ...
                <Link href="/app">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto text-base px-8 py-6 bg-purple-600/20 hover:bg-purple-600/30 text-white border-purple-400/50 hover:border-purple-400 font-medium relative shadow-lg hover:shadow-xl transition-all group">
          ...
          <div className="text-center mt-12">
            <Link href="/app">
              <Button size="lg" className="mx-auto bg-red-600 hover:bg-red-700 text-base">
                Try MarketMind AI Now <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
          </div>
        </div>
